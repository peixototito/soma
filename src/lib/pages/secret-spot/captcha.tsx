...
const Captcha: React.FC<CaptchaProps> = ({ onCaptchaCompletion }) => {
  ...
  return (
    <Box>
        ...
        <h1 style={{ color: 'black' }}> Pepe wants to learn {randomTrickName}, he is goofy</h1>
        <h1 style={{ color: 'black' }}> proove that you're cool helping Pepe to land it by</h1>
        <h1 style={{ color: 'black' }}> placing his foot in the right position for {randomTrickName}</h1>
      <Grid
